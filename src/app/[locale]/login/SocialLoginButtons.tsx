...
/**
 * 소셜 로그인: form GET + target="_self"만 사용 (같은 탭 유지).
 * 모바일에서 페이스북 로그인 시 form 제출이 새 창을 열지 않음. 버튼 클릭(window.location.href)은
 * 일부 환경에서 페이스북 OAuth로 갈 때 새 창이 뜨는 경우가 있어 form으로 통일.
 */

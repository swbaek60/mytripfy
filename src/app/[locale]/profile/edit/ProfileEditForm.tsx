...
export default function ProfileEditForm({
  ...
  const handleSave = async () => {
    ...
    const basePayload = {
      ...
      rate_currency: isGuide ? rateCurrency : 'USD',
      guide_has_vehicle: isGuide ? hasVehicle : false,
      guide_vehicle_info: isGuide && hasVehicle ? vehicleInfo : null,
      guide_vehicle_photos: isGuide && hasVehicle ? vehiclePhotos : [],
      guide_has_accommodation: isGuide ? hasAccommodation : false,
      guide_accommodation_info: isGuide && hasAccommodation ? accommodationInfo : null,

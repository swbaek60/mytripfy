  ...
  return (
    <div className="space-y-3">
      <form onSubmit={(e) => handleSubmit(e, 'google')} className="block">
        <button type="submit" className={`${btnBase} border-edge bg-surface hover:bg-surface-hover hover:border-gray-300 text-body`}>
          ...
          <span className="flex-1">{t('continueWithGoogle')}</span>
        </button>
      </form>
      ...
      <form onSubmit={(e) => handleSubmit(e, 'apple')} className="block">
        <button type="submit" className={`${btnBase} border-heading bg-heading hover:brightness-90 text-white`}>
          ...
          <span className="flex-1">{t('continueWithApple')}</span>
        </button>
      </form>
      ...
      <form onSubmit={(e) => handleSubmit(e, 'facebook')} className="block">
        <button type="submit" className={`${btnBase} border-[#1877F2] bg-[#1877F2] hover:bg-[#166FE5] text-white`}>
          ...
          <span className="flex-1">{t('continueWithFacebook')}</span>
        </button>
      </form>
    </div>
  )
